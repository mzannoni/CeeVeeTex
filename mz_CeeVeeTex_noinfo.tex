...
\begin{document}
  ...
  & \begin{minipage}{0.9\textwidth}
      ...
      \begin{itemize}
          ...
          \begin{itemize2}
              ...
              \item 3D-IC
          \end{itemize2}
          \item Project leading for analog design
  ...
  & \begin{minipage}{0.9\textwidth}
      ...
      \headerrow
  		{\textbf{GigOptix-Helix AG} (subsidiary of GigPeak, Inc.; now IDT, Inc.)}{\emph{2013 - 2017}}
      \\
      \headerrow
  ...
  & \begin{minipage}{0.9\textwidth}
      ...
      \begin{tabular*}{\textwidth}{r p{0.75\textwidth}}
        ...
        Electronic CAD:&Cadence DFII (Virtuoso, Spectre), Mentor TannerTools, Mentor Calibre, SPICE, Cadence OrCAD (PSpice), Cadence SoC Encounter, Agilent ADS\\[0.5ex]
